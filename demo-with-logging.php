...
?>
   ...
   <div id="ft" role="contentinfo"><p>follow me @<a href="http://twitter.com/thinkphp">thinkphp</a> | return to <a href="index.php">index.php</a> | source on <a href="https://github.com/thinkphp/csv2service">GitHub</a> | <a href="demo-with-logging.phps">demo-with-logging.phps</a></p></div>
</div>
</body>
</html>